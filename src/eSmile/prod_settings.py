...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'joke34$#',                  # Not used with sqlite3.
    ...
    'megiteam': {
        ...
        'NAME': '/home/gmc/www/eSmile/esmile.db',          # Or path to database file if using sqlite3.
...
EMAIL_HOST = 'gmc.megiteam.pl'
EMAIL_HOST_USER = 'yourdailyjoke@esmile.gmc.megiteam.pl'
EMAIL_HOST_PASSWORD = 'szczek'
DEFAULT_FROM_EMAIL = 'yourdailyjoke@esmile.gmc.megiteam.pl'
EMAIL_USE_TLS = True
