...
if socket.gethostname().find('megiteam.com.pl') != -1:
    print 'Running on production setting optimized for MEGITEAM.pl'
...
#        'NAME': 'd:\DEV\projects\esmile\src\eSmile\esmile.db',          # Or path to database file if using sqlite3.
